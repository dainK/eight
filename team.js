        ...
        if (!name) {
            ...
            async function SetDBUserData() {
                ...
                if( duplication ) {
                    ...
                    user_data[user_data.length.toString()] = data;
                    let setdata = {
                        user_data
                    }
                    ...
                    // AddProfileCard(data);
                    window.location.href = 'index.html?user-index:' + user_data.length.toString();
                }
           ...
           async function SetDBUserData() {
               ...
               if( removeIndex > -1 ) {
                    if( removeIndex < 5) {
                        ...
                        // TODO: 로그인한 유저가 몇번인덱스인지
    
                        let setdata = {
                            user_data
                        }
                        await setDoc(doc(db, "user", "user_data"), setdata);
                        window.location.href = 'index.html?user-index:' + user_login;
                    }
               }
               else {
...
function AddProfileCard(data) {
    ...
    profileCard.addEventListener("click", () => {
        ...
        // window.location.href = currentUrl + "?blog-index:" + id;
        window.location.href = "blog.html?user-index:"+ user_login+"?blog-index:" + id;
    });
